...
DB_GAME="bolanarede_api-postgres-game-1"
...
truncate_all() {
  ...
  docker exec "$DB_GAME" psql -U postgres -d bolanarededb_game -c \
...
main() {
  ...
  # ── Jogos Completos (popula ranking e historico) ───────────────────────────
  echo ""
  ...
  # ── Match Requests Abertos (para teste no app) ─────────────────────────────
  echo ""
