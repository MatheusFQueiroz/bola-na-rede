...
class MatchDetailPage extends StatelessWidget {
    ...
    return AppCard(
      child: Column(children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
          Column(children: [
            const AppTeamAvatar(initials: 'FU', color: AppColors.avatarGreen, size: 56),
          ...
          Column(children: [
            Text('VS', style: AppTextStyles.titleLarge.copyWith(color: AppColors.textSecondary)),
            Text('Amistoso', style: AppTextStyles.bodySmall.copyWith(color: AppColors.textDisabled)),
          ]),
          Column(children: [
            const AppTeamAvatar(initials: 'UN', color: AppColors.avatarBlue, size: 56),
            const SizedBox(height: AppSpacing.sm),
            const Text('Uniao Vila', style: AppTextStyles.titleSmall),
            Text('Sao Paulo, SP',
                style: AppTextStyles.bodySmall.copyWith(color: AppColors.textSecondary)),
          ]),
        ]),
        ...
        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text(' Arena Society Xaxim  Xaxim, SP',
              style: AppTextStyles.bodySmall.copyWith(color: AppColors.textSecondary)),
        ]),
      ]),
    );
  ...
  Widget _teamSection(String team, int confirmed, int total,
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(children: [
        Text(team, style: AppTextStyles.bodyMedium.copyWith(fontWeight: FontWeight.w600)),
        const Spacer(),
      ...
      ClipRRect(
        ...
        child: LinearProgressIndicator(
            value: confirmed / total, minHeight: 6),
      ),
      const SizedBox(height: AppSpacing.md),
      Wrap(
        ...
        children: players.map((p) => Row(mainAxisSize: MainAxisSize.min, children: [
          AppTeamAvatar(initials: p.$1, color: p.$2, size: 32, fontSize: 11),
  ...
  Widget _buildLocationCard() {
    return AppCard(
      ...
      child: Row(children: [
        ...
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            const Text('Arena Society Xaxim', style: AppTextStyles.titleSmall),
            Text('Rua das Araucarias, 450 — Xaxim',
                style: AppTextStyles.bodySmall.copyWith(color: AppColors.textSecondary)),
          ]),
        ),
      ...
      child: Row(children: [
        ...
        Expanded(
          ...
          child: AppButton.primary(
            ...
            height: AppSizes.buttonHeightSmall,
            onPressed: () => Navigator.pushNamed(context, AppRoutes.registerResult),
          ),
        ),
      ]),
    );
